...
public class LongIronButterfly extends OptionsStrategy {
	...
	private List<LongIronButterflyRow> spotlist = new ArrayList<>();
	private String disp = null;

	public LongIronButterfly(String str) {
		this.disp = str;
	}
	...
	private void generate() {
		...
		for (Double spot : spots) {
			...
			LongIronButterflyRow spotat = LongIronButterflyRow.builder().buycall(bcall).buyput(bput).sellcall(scall).sellput(sput).build();
