...
@Getter
@Setter
public class LongStrangle extends OptionsStrategy {
	...
	private List<LongStrangleRow> spotlist = new ArrayList<>();
	...
	private void generate() {
		...
		spots.forEach(s -> {
			...
			LongStrangleRow spot = LongStrangleRow.builder().spotprice(s).call(callrow).put(putrow).build();
			spotlist.add(spot);
		});



		for (LongStrangleRow spot : spotlist) {
	...
	public LongStrangle(String str) {
		this.disp = str;
	}
