...
public class ShortIronCondor extends OptionsStrategy { // Short Strangle + Long Strangle
	...
	public ShortIronCondor(String str) {
		this.disp = str;
	}
	...
	private void generate() {
		...
		for (Double spot : spots) {
			...
			ShortIronCondorRow.builder().buycall(bcall).buyput(bput).sellcall(scall).sellput(sput).build();
